...
const Navbar = () => {
  ...
  return (
    <div className="navbar fixed justify-between md:justify-center top-0 left-0 right-0 z-50 shadow bg-gray-200 dark:text-white">
      ...
      <div className="md:navbar-start">
        ...
        <Link to="/" className="text-xl md:text-2xl font-medium text-red-600">
          EQ<span className="text-green-500">Sports</span>
        </Link>
      </div>
