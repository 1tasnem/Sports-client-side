...
const Footer = () => {
  return (
    <footer className="footer text-base-content bg-slate-100 p-10">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between">
        {/* Website Name and Copyright */}
        <div className="text-center lg:text-left">
          <h1 className="text-xl font-bold text-red-500">EQ<span className="text-green-500">Sports-Material</span></h1>
        ...
        <div className="mt-4 lg:mt-0 text-center lg:text-left">
          ...
          <ul>
            <li>Email: contact@sportsequipment.com</li>
            <li>Phone: +880-123-456789</li>
            <li>Address: Motitola, Dhaka, Bangladesh</li>
          </ul>
        </div>
