                ...
                >
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <p>
                                <strong>Email:</strong> <a href="mailto:contact@bdsports.com" className="text-cyan-600 hover:underline">contact@eqsportsmaterial.com</a>
                            </p>
                            <p>
                                <strong>Phone:</strong> <a href="tel:+880123456789" className="text-cyan-600 hover:underline">+880-009-456789</a>
                            </p>
                            <p>
