...
const Login = () => {
  ...
  return (
    <div className="flex items-center bg-slate-400 justify-center">
      <div className="md:flex max-w-4xl w-full bg-white rounded-lg shadow-md overflow-hidden">
        {/* Left side: Login form */}
        <div className="md:w-1/2 p-6 bg-stone-400">
          <h2 className="text-2xl font-bold mb-6 text-center mt-10">Sign In</h2>
